...
从**功利一点的角度**来看，后端在很多团队中的确**更容易产生直接的业务价值**，并在**产品形态与系统架构上拥有更多的话语权**。
...
而从技术成长上看，后端也常常**承担“架构演进”的主力**，比如服务拆分、微服务架构设计、数据库优化、系统容错等，这些都往往是后端主导的领域。因此如果你对“做更深的技术”和“参与业务底层逻辑”的方向感兴趣，后端是一个天然更贴近这些目标的位置。
...
显而易见的缺点是它**更抽象，缺乏即时直观的反馈，入门门槛高**。可能你写了好多代码，却只实现了一个简单的增删改查。如果缺乏兴趣，缺乏引导，大概率会让你感到枯燥迷茫。对于编程基础较弱的同学，可能前面所说的“巩固”会变成“卡住”。相比之下，前端哪怕只是复制粘贴一个按钮，都能马上看到结果。
...
1. 可能是因为想看看未来是否还能从事计算机这个行业, 害怕跳火坑
2. 也可能是已经决定准备进入计算机行业, 但是对未来的发展比较担忧焦虑.  

关注点不同, 但焦虑的本质是相同的: 未来的不确定性.  

是不是有 35 岁被裁的情况呢? 的确是有的. 但是我们看问题要看本质. 行业淘汰人的原因, 不是因为年龄, 是因为性价比. 公司不会花高薪请一个拼接业务逻辑, 只会增删改查的 35 岁程序员, 但会请一个能独立承担架构、能带团队、能解决复杂问题的 35 岁工程师.

年龄只是个时间点，本质是你在这段时间有没有持续成长

我们从行业视角来看这个问题, 35 - 18 = 17 , 十几年时间, 足以天翻地覆. 十七年前, 互联网还没爆发, 云计算还没起步, AI 更是边缘话题. 十七年后, 谁能预测行业变成什么样?

与其担忧未来这个行业会不会有危机, 不如承认计算机这个行业就是一个充满变化的行业.  

这里又有一个个人选择的问题. 你最终想要的到底是什么? 你是想要高薪, 还是喜欢编程, 还是想成为某个领域的专家, 还是想成为一步步爬升, 做技术管理?  想清楚之后, 你才能做准备.  

不过不管怎样来说, 三十五岁太遥远了, 我们更应该关注当下的事情.  

我能学什么，让简历上更有亮点？ 我能做什么项目，能体现解决问题的能力？ 我能利用大学的环境，去尝试哪些有趣的事情？

未来不可控，当下才是你能左右的, 只有较近的未来是能被计划的.  

### AI 发展, 未来计算机是土木吗

首先要区分：土木和软件工程有本质上的不同。

土木和软件工程不一样的地方在于, 土木改造物理世界, 软件改造数字世界. 土木有物理极限, 市场会饱和, 但软件的需求是可以膨胀的, 技术迭代速度远快于土木, 各行各业对于软件的需求是可以转移和升级, 而不会消失的. 因此软件相关的岗位大概率会在比较长的时间里一直存在.  

AI 在软件领域目前主要扮演的是 提效工具 的角色。它可以让开发更快，但真正要它独立完成一个大规模项目，距离现实还有差距。对于就业而言, 悲观的角度看，也许几年后 AI 的迭代能做到自动设计、自动开发、自动运维，那么传统的“低层次程序员”一定会被淘汰。

但是每一波技术浪潮, 旧岗位消失的同时，新岗位也会诞生。今天 AI 火爆，Agent 开发、AI 产品设计就是新的需求；几年后，可能会出现我们现在还想不到的机会。谁知道几年之后的行业样子呢?  

未来的开发者门槛会提高。单纯写 CRUD 代码的价值会下降，而更需要的是**架构师思维和产品思维**, 因为真正重要的不是技术, 而是业务. 技术是为了业务服务的. 用户真正需要什么？ 产品目标群体是谁？ 产品的商业模式如何？ 这些实际的业务问题，比单纯的技术实现细节更能决定一个人在公司中的不可替代性。
