...
$$
H(s) = \frac{Y(s)}{X(s)} = \frac {As^2 + Bs + C}{Ds^2 + Es + F}
$$
...
上面的证明过程其实就做了一个卷积运算. 只不过这里的向量变成了函数. 但实际上函数也看作是一个无穷维度的向量.

[3Blue1Brown 线性代数的本质 - 11 抽象向量空间](https://www.bilibili.com/video/BV1ys411472E/?p=15)
